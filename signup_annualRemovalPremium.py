...
try:
        ...
        input4.send_keys("annualRemovalPremium@annualRemovalPremium.com")
        ...
        option2 = browser.find_element_by_css_selector(".payment-model__main-list-radio-label")
        option2.click()
        option3 = browser.find_element_by_css_selector("[id='annualRemovalPremium']")
        option3.click()
